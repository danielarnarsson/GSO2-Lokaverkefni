...
FROM MOVIE, DETAILRENTAL, RENTAL, VIDEO
WHERE DETAIL_RETURNDATE <= DETAIL_DUEDATE
AND DETAILRENTAL.RENT_NUM LIKE RENTAL.RENT_NUM
AND VIDEO.VID_NUM LIKE DETAILRENTAL.VID_NUM
AND VIDEO.MOVIE_NUM LIKE MOVIE.MOVIE_NUM;
...
ALTER TABLE VIDEO
    ...
    ADD CONSTRAINT CHK_VID_STATUS CHECK (VID_STATUS IN ('IN', 'OUT', 'LOST'));
